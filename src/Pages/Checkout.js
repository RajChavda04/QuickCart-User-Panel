        ...
        <>
            ...
            <section class="checkout-section pt-100 pb-100">
                ...
                <div class="container">
                    ...
                    <div class="row">
                        {/* enetr here customer data */}
                        <div class="checkout-left">
                            <div class="col-lg-6 col-md-12"  >
                                <div class="row contact-wrap">
                                    <div class="checkout-left">
                                        <h3 class="form-header">Billing Details</h3>
                                        <h4>Check your details carefully</h4>
                                        {list && list.length > 0 ? (
                                            list.map((val, index2) => (
                                                    ...
                                                    <div class="form-group row">
                                                        <div class="col-md-12">
                                                            <div class="form-item ">
                                                                ...
                                                                <input type="text" id="customer_address" name="customer_address" value={val.customer_address} class="form-control street-control" />
                                                ...
                                                <div class="order-item" key={index} >
                                                    ...
                                                    <div class="order-right">
                                                        <div class="content">
                                                            ...
                                                            <span class="price">{val.product_quantity}</span>
                                                        </div>
